...
import { countCommentsOfActionTYpe } from "../states";
  ...
  return (
    ...
    >
      <Show
        ...
        fallback={
          <div class="flex w-[54px] h-[54px] rounded-full justify-center items-center bg-crab-green text-white text-custom13 font-medium shadow-[0px_2px_4px_rgba(0,0,0,0.2)]">
            {" "}
            Submit
          </div>
        }
    ...
    <div class="w-full relative font-medium">
      <div class="absolute right-0 bottom-0">
        <div class="relative flex flex-col items-center justify-center">
          ...
          />
          <span
            class={`absolute inset-0 flex flex-col items-center justify-center font-medium pointer-events-none text-white space-y-0.5`}
          >
            <Show when={value() !== min} fallback={<div>Done!</div>}>
              <div>← Slide to confirm submitting</div>
