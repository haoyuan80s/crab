import { PostWithCrawlResponse, UserWatch } from "./model";
...
export const mockUserWatch: UserWatch = {
    activePostIds: ["kIo2BAubO6k", "KosgUhdAL5w", "31FpW6CMmYE", "4hBpLHqBSOg", "oZozNrtbg-o"],
...
export const mockPostWithCrawlResponse: PostWithCrawlResponse[] = [
    {
        post: {
            ...
            postSummary: "上期咱们聊了全球十大主权基金里面的6个。 今天咱们接着来揭晓更重磅的部分，来看一看全世界最大的三大国家主权基金~",
    ...
    },
    {
        post: {
            ...
            postSummary: "你好奇吗？我是怎么赚钱的？ 我们的团队是怎么运作的？ 今天就来聊聊这个话题~",
            postCreatedAtCommunityTime: new Date("2025-03-14T14:42:27"),
            postLastCommentTime: new Date("2025-03-14T14:42:27"),
            postLastCrawledTime: new Date("2025-03-14T14:42:27"),
            channelId: "xiao_lin_shuo",
    ...
    },
    {
        post: {
            ...
            postSummary: "朋友们，咱们今天来深度颇析一下，全世界最有钱的一些政府，它们是怎么管理自己的钱袋子的。全球十大主权基金，它们都是哪来的那么多钱？各自是怎么管理这动辄几千亿、上万亿美元的财富的？背后又有什么投资逻辑~",
            postCreatedAtCommunityTime: new Date("2025-03-14T14:42:27"),
            postLastCommentTime: new Date("2025-03-14T14:42:27"),
            postLastCrawledTime: new Date("2025-03-14T14:42:27"),
            channelId: "xiao_lin_shuo",
    ...
    },
    {
        post: {
            ...
            postSummary: "你好奇吗？中国的财政体系是怎么样的？ 12万亿化债又是怎么回事？ 今天就来聊聊这个话题~",
            postCreatedAtCommunityTime: new Date("2025-03-14T14:42:27"),
            postLastCommentTime: new Date("2025-03-14T14:42:27"),
            postLastCrawledTime: new Date("2025-03-14T14:42:27"),
            channelId: "xiao_lin_shuo",
